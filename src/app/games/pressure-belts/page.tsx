...
export default function PressureBeltsPage() {
    ...
    useEffect(() => {
        ...
        async function init() {
            ...
            const flowZones = [
                { lat: 15, dLat: -1, dLong: -1 },   // NE Trades
                { lat: -15, dLat: 1, dLong: -1 },  // SE Trades
                { lat: 45, dLat: 1, dLong: 1 },    // N Westerlies
                { lat: -45, dLat: -1, dLong: 1 },  // S Westerlies
                { lat: 75, dLat: -1, dLong: -1 },  // N Easterlies
                { lat: -75, dLat: 1, dLong: -1 }   // S Easterlies
            ];
            ...
            const handleZoom = (delta: number) => {
                ...
                if (camera.position.z < config.minZoom) camera.position.z = config.minZoom;
                if (camera.position.z > config.maxZoom) camera.position.z = config.maxZoom;
            };
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', background: '#000' }}>
            ...
            <div id="ui-layer" style={{ position: 'absolute', top: '25px', left: '25px', color: 'white', pointerEvents: 'none', zIndex: 10 }}>
                <div className="panel" style={{
                    ...
                    backdropFilter: 'blur(15px)', borderRadius: '0 15px 15px 0', boxShadow: '0 10px 40px rgba(0,0,0,0.8)', maxWidth: '300px'
                }}>
