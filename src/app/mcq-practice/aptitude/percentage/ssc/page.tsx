...
const mcqData = [
    {
        type: "Type 1",
        questionNumber: 1,
        question: "This is a placeholder question for Percentage (SSC).",
            ...
            <div className="container mx-auto py-12 px-4 md:px-6 flex justify-center items-center h-full">
                <Card className="w-full max-w-xl text-center">
                    <CardHeader>
                        ...
                        <CardDescription>You have completed the Percentage (SSC) quiz in {formatTime(time)}.</CardDescription>
                    </CardHeader>
                    <CardContent>
