...
const examCategories = [
  ...
  { name: "Railway", icon: Train, href: "#" },
  { name: "Banking", icon: Banknote, href: "#" },
  { name: "OSSC", icon: PenTool, href: "#" },
  { name: "Mix", icon: Mix, href: "#" },
];

export default function DictionaryOrderPage() {
  const topicName = "Dictionary Order";
    ...
    <div className="container mx-auto py-12 px-4 md:px-6">
      ...
      <div className="max-w-4xl mx-auto grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {examCategories.map((category) => (
          <Link key={category.name} href={`/mcq-practice/reasoning/dictionary-order/${category.href}`}>
