...
export default function KVSClassPage({ params }: { params: { class: string } }) {
  ...
  const subjectsOrStreams = kvsSubjects[className] || [];
  ...
  return (
    <div className="container mx-auto py-12 px-4 md:px-6">
      <div className="space-y-4 text-center mb-12">
        <h1 className="text-3xl md:text-4xl font-bold font-headline">Subjects for {classTitle} (KVS / CBSE)</h1>
        <p className="text-muted-foreground md:text-xl">Complete study materials following the KVS/CBSE curriculum</p>
      </div>
