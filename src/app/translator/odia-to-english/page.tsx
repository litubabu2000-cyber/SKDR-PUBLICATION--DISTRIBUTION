...
export default function OdiaToEnglishPage() {
  return (
    <div className="container mx-auto py-12 px-4 md:px-6">
      <div className="space-y-4 text-center mb-12">
        <h1 className="text-3xl md:text-4xl font-bold font-headline">Odia to English Translator</h1>
        <p className="text-muted-foreground md:text-xl">Translate your text from Odia to English</p>
      </div>
